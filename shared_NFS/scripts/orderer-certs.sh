...
set -x
fabric-ca-client enroll -u https://admin:adminpw@ca-orderer:7054 --caname ca-orderer --tls.certfiles "/organizations/fabric-ca/ordererOrg/tls-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@ca-orderer:7054 --caname ca-orderer -M "/organizations/ordererOrganizations/example.com/users/Admin@example.com/msp" --tls.certfiles "/organizations/fabric-ca/ordererOrg/tls-cert.pem"
{ set +x; } 2>/dev/null
